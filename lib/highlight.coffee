  ...
  <body>
    ...
    <script type="text/javascript">
      SyntaxHighlighter.autoloader(
        ...
        'bash shell				{ROOT}/scripts/shBrushBash.js',
        'coldfusion cf			{ROOT}/scripts/shBrushColdFusion.js',
        'cpp c					{ROOT}/scripts/shBrushCpp.js',
        'c# c-sharp csharp		{ROOT}/scripts/shBrushCSharp.js',
        ...
        'java					{ROOT}/scripts/shBrushJava.js',
        ...
        'text plain				{ROOT}/scripts/shBrushPlain.js',
